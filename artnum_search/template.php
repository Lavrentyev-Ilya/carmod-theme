...
if($aRes['PRODUCTS']){?>
	<div class="Popup_n">
		<div class="PopupContent_n">
			...
			<div id="ImgContainer" class="image-container">
				...
				<div class="CmShemaCoord" style="left:50.000%; width:3.367%; top:36.601%; height:3.011%;"></div>
			</div>
	...
	foreach($aRes['PRODUCTS'] as $aP){
		?><tr><td>
			...
			<td><a href="<?=$aP['Link']?>" class="CmSearchBox CmSearchActive">
				...
				<br>
				<span class="CmSearchName"><?=$aP['Name']?></span>
			</a>
		</td></tr><?
	}
	?></table><?
}else{
	echo '<span>SEARCH_NOT_FOUND</span>';
