...
if(IsADMIN_x AND defined('CM_RNDV') AND CM_RNDV){$v=rand(11111,99999);}else{$v=CM_VERSION;}?>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet" href="/<?=CM_DIR?>/templates/<?=TEMPLATE_x?>/common.css?v=<?=$v?>" type="text/css">
<link rel="stylesheet" href="/<?=CM_DIR?>/templates/<?=TEMPLATE_x?>/custom.css" type="text/css">
<script src="/<?=CM_DIR?>/media/js/common.js?v=<?=$v?>"></script>
...
<script src="/<?=CM_DIR?>/templates/<?=TEMPLATE_x?>/common.js?v=<?=$v?>"></script>
...
<style>
:root{
	--mainselector-font:"Montserrat", sans-serif;
}
...
//            if($Crumb){$arrow='<div class="CmCrumbArr" style="background-image:url('.TEMPLDIR_x.'_images/arrow.png)"></div>';}
            if($Link!='' OR $Crumb=='Home'){
                ...
                if($Crumb=='Home'){
                    $Crumb = '<svg class="CmBcHomeIcon" viewBox="0 0 24 24"><path d="M 12 2.0996094 L 1 12 L 4 12 L 4 21 L 10 21 L 10 14 L 14 14 L 14 21 L 20 21 L 20 12 L 23 12 L 12 2.0996094 z"/></svg>';
                ...
                ?><li class="CmBrCrItem" property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" href="<?=$Href?>">
                        <span class="CmUnderLineHover"  property="name"><?=$Crumb?></span>
                    </a>
...
function PrintProductAvailable_x($aPrice, $Res=Array()){
    if(HIDE_PRODUCTS_COUNT){
		...
		if($aPrice['AVAILABLE_VIEW']==0){$aPrice['AVAILABLE_VIEW']='<b>&#215;<b>';}?>
        <div class="CmListPrAvail"><?=round((float)$aPrice['AVAILABLE_VIEW'],2)?></div>
    <?}
}
?>
